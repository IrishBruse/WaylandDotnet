...
public partial class ProtocolGenerator
{
    ...
    private readonly Dictionary<string, bool> interfaceNeedsDisplay = new();
    ...
    public void Generate(ProtocolMetadata metadata)
    {
        ...
        InitializeDocumentation(metadata, protocol);
